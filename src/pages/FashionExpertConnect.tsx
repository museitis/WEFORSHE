...
const FashionExpertConnect: FunctionComponent = () => {
  const navigate = useNavigate();

  const onRectangleClick = useCallback(() => {
    navigate("/chat-with-abha");
  }, [navigate]);
  ...
  return (
    <div className="w-full relative rounded-xl bg-whitesmoke h-[800px] overflow-hidden text-center text-2xs text-black font-open-sans">
      ...
      <img
        ...
        src="/vector.svg"
      />
      <div className="absolute top-[calc(50%_-_345px)] left-[calc(50%_-_126px)] text-xs text-gray-1100 inline-block w-[98px] h-3.5">
        Search by name
      </div>
      <img
        className="absolute top-[76.6px] left-[311px] w-[17px] h-[16.4px] object-contain"
        alt=""
        src="/group-335313@2x.png"
      />
      <img
      ...
      />
      <div
        className="absolute top-[131px] left-[6px] shadow-[0px_2px_8px_4px_rgba(0,_0,_0,_0.1)] rounded-lg bg-darkslateblue w-[347px] h-[135px] cursor-pointer"
...
export default FashionExpertConnect;
