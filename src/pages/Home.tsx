...
const Home: FunctionComponent = () => {
  ...
  const onGARMENTSContainerClick = useCallback(() => {
    navigate("/styling");
  }, [navigate]);

  const onGARMENTSContainerClick1 = useCallback(() => {
    navigate("/matching");
  }, [navigate]);

  const onTOYSContainerClick = useCallback(() => {
    navigate("/purchasing");
  }, [navigate]);

  const onGROCERYContainerClick = useCallback(() => {
  ...
  return (
    <div className="w-full relative rounded-xl bg-white h-[800px] overflow-hidden text-left text-base text-black font-open-sans">
      ...
      />
      <div
        className="absolute top-[246px] left-[calc(50%_-_145px)] w-72 h-[52px] cursor-pointer"
        onClick={onGARMENTSContainerClick}
      >
      ...
      <div
        className="absolute top-[317px] left-[calc(50%_-_145px)] w-72 h-[52px] cursor-pointer"
        onClick={onGARMENTSContainerClick1}
      >
      ...
      <div
        className="absolute top-[388px] left-[calc(50%_-_145px)] w-72 h-[52px] cursor-pointer"
        onClick={onTOYSContainerClick}
      >
        <div className="absolute top-[0px] left-[calc(50%_-_144px)] rounded-8xs bg-indianred-300 w-72 h-[52px]" />
        <div className="absolute top-[14px] left-[67px]">Purchasing</div>
      </div>
      <div
        className="absolute top-[459px] left-[calc(50%_-_145px)] w-72 h-[52px] cursor-pointer"
        onClick={onGROCERYContainerClick}
      >
        <div className="absolute top-[0px] left-[calc(50%_-_144px)] rounded-8xs bg-indianred-300 w-72 h-[52px]" />
        <img
      ...
      <div
        className="absolute top-[530px] left-[calc(50%_-_145px)] w-72 h-[52px] cursor-pointer"
        onClick={onGroupContainerClick}
      >
        <div className="absolute top-[0px] left-[calc(50%_-_144px)] rounded-8xs bg-indianred-300 w-72 h-[52px]" />
        <div className="absolute top-[12px] left-[115px]">Others</div>
      </div>
      <div className="absolute top-[616px] left-[calc(50%_-_75px)] w-[159px] h-[39px] text-center text-xl text-white font-montserrat">
      ...
      />
      <img
        className="absolute top-[397px] left-[50px] w-[31px] h-[31px] object-contain"
        alt=""
        src="/mask-group@2x.png"
      />
      <img
        className="absolute top-[255px] left-[47px] w-[34px] h-[34px] object-cover"
        alt=""
