...
const Matching: FunctionComponent = () => {
  ...
  return (
    <div className="w-full relative rounded-xl bg-white h-[800px] overflow-hidden text-left text-base text-black font-open-sans">
      ...
      <div className="absolute top-[459px] left-[calc(50%_-_145px)] w-72 h-[52px]">
        <div className="absolute top-[0px] left-[calc(50%_-_144px)] rounded-8xs bg-indianred-300 w-72 h-[52px]" />
        <img
      ...
      <img
        className="absolute top-[324px] left-[44px] w-[43px] h-[43px] object-contain"
        alt=""
      ...
      />
      <img
        className="absolute top-[255px] left-[47px] w-[34px] h-[34px] object-contain"
        alt=""
        src="/mask-group1@2x.png"
      />
      <div className="absolute top-[315px] left-[calc(50%_-_145px)] w-72 h-[52px]">
