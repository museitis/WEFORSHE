...
const Others: FunctionComponent = () => {
  ...
  return (
    <div className="w-full relative rounded-xl bg-white h-[800px] overflow-hidden text-left text-base text-black font-open-sans">
      ...
      <div className="absolute top-[530px] left-[calc(50%_-_145px)] w-72 h-[52px] text-white">
      ...
      <img
        className="absolute top-[38px] left-[21px] w-5 h-5 object-cover cursor-pointer"
        alt=""
        src="/arrow@2x.png"
