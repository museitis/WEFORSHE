...
const Purchasing: FunctionComponent = () => {
  ...
  return (
    <div className="w-full relative rounded-xl bg-white h-[800px] overflow-hidden text-left text-base text-black font-open-sans">
      ...
      <div className="absolute top-[388px] left-[calc(50%_-_145px)] w-72 h-[52px] text-white">
      ...
      <div className="absolute top-[255px] left-[47px] w-[34px] h-[173px]">
        ...
        />
        <img
          className="absolute top-[142px] left-[3px] w-[31px] h-[31px] object-cover"
          alt=""
          src="/shopping-bag-full@2x.png"
        />
      </div>
      <img
